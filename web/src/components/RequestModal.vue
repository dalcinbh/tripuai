<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm">
    <div class="bg-white rounded-2xl shadow-2xl w-[95%] sm:w-full sm:max-w-lg overflow-hidden border border-neutral-200 animate-in fade-in zoom-in duration-200">
